...
const BuyEthCard = ({ buttonName = 'Buy', bscWeb3, ethWeb3,data, walletvalue, loadWeb3 }) => {
        ...
        <audeo className="card__img" controls>
          ...
          Your browser does not support the video tag.
            ...
            <div className='card__content'>
                ...
                <button className='content___buy'onClick={buytoken}>Buy</button>
